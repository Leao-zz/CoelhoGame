...
assert.match(app, /const ASSET_VERSION = '28'/);
...
assert.match(app, /const finalRound = remaining <= 0/);
assert.match(app, /finalRound \? 'FINAL' : String\(remaining\)/);
assert.match(app, /finalRound \? 'RODADA' : 'FORTUNA'/);
assert.match(app, /finalRound \? 'BOA SORTE'/);
